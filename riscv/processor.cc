...
void processor_t::disasm(insn_t insn)
{
  ...
  if (last_pc != state.pc || last_bits != bits) {
	...
	<< "," << std::setw(8) << state.csrmap[CSR_MISA]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MHARTID]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MIP]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MIE]->read()

	<< "," << std::setw(8) << state.csrmap[CSR_MIDELEG]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MEPC]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MTVAL]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MTVEC]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MSCRATCH]->read()

	<< "," << std::setw(8) << state.csrmap[CSR_SSTATUS]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_SIP]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_SIE]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_SEPC]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_STVAL]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_SSCRATCH]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_SATP]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_STVEC]->read()
	//<< "," << std::setw(8) << state.csrmap[CSR_WFI]->read()

	<< "," << std::setw(8) << state.csrmap[CSR_DPC]->read()
	//<< "," << std::setw(8) << state.csrmap[CSR_DSCRATCH]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_TSELECT]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_TDATA1]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_TDATA2]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_TDATA3]->read()

	<< "," << std::setw(8) << state.csrmap[CSR_MCOUNTINHIBIT]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_CYCLE]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_INSTRET]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MHPMEVENT3]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_MHPMCOUNTER3]->read()

	<< "," << std::setw(8) << state.csrmap[CSR_VSTART]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_VXSAT]->read()
	<< "," << std::setw(8) << state.csrmap[CSR_VXRM]->read()

	<< "," << std::setw(8) << state.csrmap[CSR_PMPCFG0]->read()

	<< "," << std::setw(8) << state.csrmap[CSR_PMPADDR0]->read()
